...
try {
    $low = $pdo->query('SELECT * FROM products WHERE ' . $productsActiveClause . ' AND quantity <= low_stock_threshold')->fetchAll();
} catch (Exception $e) {
...
<body>
    ...
    <script src="../dgz_motorshop_system/assets/js/dashboard/topSellingFilters.js"></script>
