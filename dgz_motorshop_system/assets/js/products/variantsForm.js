    ...
    function initialiseVariantEditor(editor) {
        ...
        function hydrateFromDataset() {
            ...
            if (!Array.isArray(parsed) || parsed.length === 0) {
                addVariant({ label: '', price: 0, quantity: 0, variant_code: '', is_default: true });
            } else {
        ...
        addButton?.addEventListener('click', (event) => {
            ...
            addVariant({ label: '', price: 0, quantity: 0, variant_code: '', is_default: rowsContainer.children.length === 0 });
        });
